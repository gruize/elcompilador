...
public class DatosToken {
	 ...
	 * @param fila
	 *            Fila en la que se encuentra el token dentro del programa
	 * @param columna
	 *            Columna en la que se encuentra el token dentro del programa
	 * @param indice
	 *            Posición global en la que se encuentra el token dentro del
	 *            programa
	 */
	 ...
	 *            Identificador del token
	 * @param indice
	 *            Posicion global en la que se encuentra el token dentro del
	 *            programa
	 */
